...
public class PersonDaoVanillaJdbcTest extends AbstractTransactionalTestNGSpringContextTests {
	...
	private void dataSetup() {
		...
		jdbcTemplate
				.execute("create table person (id bigint generated by default as identity, name varchar(255), firstname varchar(255), primary key (id))");
		jdbcTemplate
				.execute("create table person_address (id bigint generated by default as identity, person_id bigint, box varchar(255), country varchar(255), housenumber varchar(255), municipality varchar(255), postalcode varchar(255), street varchar(255), primary key (id), foreign key (person_id) references person(id))");
