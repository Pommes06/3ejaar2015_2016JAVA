...
import be.groept.chat.ChatServer;
...
public abstract class ChatServerWSImpl implements ChatServer {

	private ConcurrentHashMap<String, UserData> users = new ConcurrentHashMap<>();

	@Override
	public UUID logon(String nickName)  {
	...
	@Override
	public void post(UUID uuid, String message)  {
	...
	@Override
	public String listen(UUID uuid) {
		try {
